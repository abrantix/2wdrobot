#ifndef _ASYNC_STREAM_RESPONSE
#define _ASYNC_STREAM_RESPONSE

//credits: https://gist.github.com/me-no-dev/d34fba51a8f059ac559bf62002e61aa3
    ...
    public:
        ...
        size_t _content(uint8_t *buffer, size_t maxLen, size_t index){
            ...
            if(!_frame.fb || _frame.index == _jpg_buf_len){
                ...
                //send header
                size_t hlen = sprintf((char *)buffer, STREAM_PART, JPG_CONTENT_TYPE, _jpg_buf_len, _frame.fb->timestamp.tv_sec, _frame.fb->timestamp.tv_usec);
                buffer += hlen;
                //send frame
